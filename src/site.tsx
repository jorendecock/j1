...
export const info = {
  ...
  photos: [
    ...
    { src: "/images/project-01/foto0b.jpeg", size: "M" as ProjectSize, align: "right" as ProjectAlign },
    { src: "/images/foto0c.jpeg", size: "M" as ProjectSize, align: "left" as ProjectAlign },
    { src: "/public/project-01/foto0d.jpeg", size: "S" as ProjectSize, align: "center" as ProjectAlign },
  ],
  links: [
